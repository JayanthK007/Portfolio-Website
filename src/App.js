...
function App() {
  ...
  const experience = [
    ...
    },
    {
      ...
      points: [
        "Developed Spring Boot RESTful APIs to optimize policy retrieval for 100K+ users, reducing response time by 40%",
        "Engineered a scalable microservices backend capable of handling 30K+ concurrent users efficiently",
        "Optimized database queries via Spring Data JPA, increasing throughput by 15% for high-traffic endpoints",
        "Implemented secure authentication and role-based access control with Spring Security, enhancing system security"
      ]
    },
    {
